...
export default class Digits extends Component {
    ...
    onUpload = (e) => {
        ...
        axios.post("http://localhost:3001/balvibhag/add-bvimage", data).then((res) => {
            console.log(res);
        })
    }

    onSubmit = (e) => {
        axios.post("http://localhost:3001/balvibhag/add-balvibhag", this.state).then((res) => {
            console.log(res);
    ...
    deleteRecord(id) {
        ...
        swal({
            title: "Are you sure?",
            text: "You want to Delete this Digit !",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
            .then((willDelete) => {
                if (willDelete) {
                    axios.post("http://localhost:3001/balvibhag/delete-digit", {type : this.state.table_type, id : id}).then((res) => {
                        this.handleShow1();                        
                    })
                } else {
    ...
    handleShow = (e) => {
        this.setState({table_type : e.target.value}, () => {
            axios.post("http://localhost:3001/balvibhag/get-all-digit", {type : this.state.table_type}).then((res) => {
    ...
    render() {
        return (
            <div>
                        ...
                        <div className="spContainer mx-auto">
                            <div className="card px-4 py-5 border-0 shadow">
                                <div className="d-inline text-left mb-3">
                                    <h3 className="font-weight-bold">Add Digits</h3>
                                </div>
                ...
                <button type="button" class="btn btn-warning" data-toggle="modal" data-target=".bd-example-modal-lg">See Digit List</button>

                <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title">Digit List</h3>
